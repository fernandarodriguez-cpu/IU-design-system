 ...
 */
export const KSheetRoot = DialogPrimitive.Root;
export const KSheetTrigger = DialogPrimitive.Trigger;
export const KSheetPortal = DialogPrimitive.Portal;
export const KSheetClose = DialogPrimitive.Close;
export const KSheet = DialogPrimitive.Root;
...
export interface KSheetProps extends Omit<React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>, 'title'> {
...
export const KSheetOverlay = React.forwardRef<
...
KSheetOverlay.displayName = "KSheetOverlay";

export const KSheetContent = React.forwardRef<
