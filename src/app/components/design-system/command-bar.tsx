...
const allItems: SearchItem[] = [
  ...
  // Moléculas extendidas (v2.0)
  { id: 'm-inputnumber', label: 'KInputNumber', category: 'Molécula', path: '/molecules/input-number', keywords: ['input', 'number', 'numero', 'cantidad', 'step', 'incrementar'], icon: <Layers size={16} /> },
  { id: 'm-segmented', label: 'KSegmented', category: 'Molécula', path: '/molecules/segmented', keywords: ['segmented', 'tabs', 'toggle', 'opciones', 'control', 'ios'], icon: <Layers size={16} /> },
  { id: 'm-autocomplete', label: 'KAutocomplete', category: 'Molécula', path: '/molecules/autocomplete', keywords: ['autocomplete', 'search', 'sugerencias', 'buscar', 'completar'], icon: <Layers size={16} /> },
  { id: 'm-datepicker', label: 'KDatePicker', category: 'Molécula', path: '/molecules/date-picker', keywords: ['date', 'picker', 'fecha', 'calendario', 'seleccionar'], icon: <Layers size={16} /> },
  { id: 'm-daterange', label: 'KDateRangePicker', category: 'Molécula', path: '/molecules/date-range', keywords: ['date', 'range', 'rango', 'fechas', 'periodo', 'desde', 'hasta'], icon: <Layers size={16} /> },
  { id: 'm-selectadv', label: 'KSelectAdvanced', category: 'Molécula', path: '/molecules/select-advanced', keywords: ['select', 'multi', 'tags', 'multiple', 'advanced', 'avanzado'], icon: <Layers size={16} /> },
  { id: 'm-descriptions', label: 'KDescriptions', category: 'Molécula', path: '/molecules/descriptions', keywords: ['descriptions', 'detalle', 'clave', 'valor', 'info', 'resumen'], icon: <Layers size={16} /> },
  { id: 'm-popconfirm', label: 'KPopconfirm', category: 'Molécula', path: '/molecules/popconfirm', keywords: ['popconfirm', 'confirmar', 'eliminar', 'borrar', 'seguro'], icon: <Layers size={16} /> },
  { id: 'm-result', label: 'KResult', category: 'Molécula', path: '/molecules/result', keywords: ['result', 'resultado', 'exito', 'error', '404', '500', 'estado'], icon: <Layers size={16} /> },
  { id: 'm-timeline', label: 'KTimeline', category: 'Molécula', path: '/molecules/timeline', keywords: ['timeline', 'historial', 'eventos', 'linea', 'tiempo', 'cronologia'], icon: <Layers size={16} /> },
  // Organismos
  ...
  { id: 'o-sparkline', label: 'KSparklineCell', category: 'Organismo', path: '/organisms/sparkline', keywords: ['sparkline', 'chart', 'grafico', 'tendencia', 'mini', 'linea'], icon: <Box size={16} /> },
  { id: 'o-commandbar', label: 'KCommandBar', category: 'Organismo', path: '/organisms/command-bar', keywords: ['command', 'bar', 'search', 'buscar', 'ia', 'ai', 'ctrl k'], icon: <Box size={16} /> },
  // Organismos extendidos (v2.0)
  { id: 'o-upload', label: 'KUpload', category: 'Organismo', path: '/organisms/upload', keywords: ['upload', 'subir', 'archivo', 'file', 'drag', 'drop', 'imagen'], icon: <Box size={16} /> },
  { id: 'o-tree', label: 'KTree', category: 'Organismo', path: '/organisms/tree', keywords: ['tree', 'arbol', 'jerarquia', 'carpetas', 'nodos', 'expandir'], icon: <Box size={16} /> },
  { id: 'o-tour', label: 'KTour', category: 'Organismo', path: '/organisms/tour', keywords: ['tour', 'guia', 'onboarding', 'tutorial', 'pasos', 'recorrido'], icon: <Box size={16} /> },
  { id: 'o-modalconfirm', label: 'KModalConfirm', category: 'Organismo', path: '/organisms/modal-confirm', keywords: ['modal', 'confirm', 'confirmar', 'dialogo', 'eliminar', 'accion'], icon: <Box size={16} /> },
  { id: 'o-formlist', label: 'KFormList', category: 'Organismo', path: '/organisms/form-list', keywords: ['form', 'list', 'dynamic', 'campos', 'agregar', 'eliminar', 'repetir'], icon: <Box size={16} /> },
  // Templates
