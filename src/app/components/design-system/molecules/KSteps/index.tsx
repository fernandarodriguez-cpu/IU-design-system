            ...
            <div className={cn(
              ...
              <div className="relative shrink-0">
                <div className={cn(
                  ...
                  stepStatus === 'finish' ? "bg-[var(--khor-primary)] border-[var(--khor-primary)] text-white" :
                  stepStatus === 'process' ? "bg-white border-[var(--khor-primary)] text-[var(--khor-primary)] shadow-[0_0_12px_rgba(var(--khor-primary-rgb),0.3)] scale-110" :
                  stepStatus === 'error' ? "bg-red-50 border-red-500 text-red-500" :
                  "bg-white border-[var(--khor-neutral-200)] text-[var(--khor-neutral-400)]"
                )}>
                ...
                {direction === 'vertical' && !isLast && (
                  <div className="absolute left-1/2 -translate-x-1/2 top-10 bottom-[-10px] w-[2px] bg-[var(--khor-neutral-100)] overflow-hidden">
                    <div className={cn("w-full h-full bg-[var(--khor-primary)] origin-top transition-transform duration-700", isFinished ? "scale-y-100" : "scale-y-0")} />
                  </div>
                )}
              </div>
              ...
              <div className={cn(
                ...
                <h4 className={cn(
                  ...
                  isCurrent ? "text-[var(--khor-neutral-900)]" : "text-[var(--khor-neutral-500)]"
                )}>
                  {item.title}
                </h4>
                {item.description && (
                  <p className="text-[11px] font-medium text-[var(--khor-neutral-400)] leading-tight mt-0.5 line-clamp-2">
                    {item.description}
                  </p>
                )}
              </div>
              ...
              {direction === 'horizontal' && !isLast && (
                <div className="hidden md:block flex-1 h-[2px] bg-[var(--khor-neutral-100)] mt-5 mx-4 overflow-hidden rounded-full">
                   <div className={cn("w-full h-full bg-[var(--khor-primary)] origin-left transition-transform duration-700", isFinished ? "scale-x-100" : "scale-x-0")} />
                </div>
              )}
            </div>
          </div>
