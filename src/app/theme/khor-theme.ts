...
export const khorTokens = {
  ...
  typography: {
    ...
    h2: { size: 'var(--khor-font-size-h2)', weight: 'var(--khor-font-weight-semibold)', lineHeight: 'var(--khor-line-height-heading)' },
    h3: { size: 'var(--khor-font-size-h3)', weight: 'var(--khor-font-weight-bold)', lineHeight: 'var(--khor-line-height-heading)' },
    h4: { size: 'var(--khor-font-size-h4)', weight: 'var(--khor-font-weight-semibold)', lineHeight: 'var(--khor-line-height-heading)' },
    h5: { size: 'var(--khor-font-size-h5)', weight: 'var(--khor-font-weight-bold)', lineHeight: 'var(--khor-line-height-body)' },
